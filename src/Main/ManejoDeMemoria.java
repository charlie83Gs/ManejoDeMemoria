...
"arriba",
           ManualDeUsuario = "Aspectos importantes:\n" +
"\n \n" +
...
"\n \n" +
"-Si un proceso se queda sin pagina y no puede obtener páginas debido a su prioridad la simulación le dará una página aleatoria\n" +
"\n \n" +
...
"\n \n" +
"-Por limitaciones gráficas se recortó el máximo de la lista de requerimientos a 20 que sale en el texto, si la lista excede este valor se pone un +N con N siendo la cantidad de páginas que siguen en la lista de requerimientos\n" +
"\n \n" +
"-El algoritmo de pre-cleaning se ejecuta cada 5 iteraciones\n" +
"\n \n" +
